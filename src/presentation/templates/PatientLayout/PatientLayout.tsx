...
export function PatientLayout({ children, title, subtitle, actions }: PatientLayoutProps) {
    ...
    <div className="flex min-h-screen bg-gray-50">
      <aside className="fixed inset-y-0 left-0 z-20 flex w-60 flex-col bg-gray-900">
        <div className="flex items-center gap-3 border-b border-white/[0.08] px-5 py-6">
          <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-[10px] bg-blue-600">
                ...
                <li key={item.to}>
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive ? 'bg-blue-600 text-white' : 'text-white/60 hover:bg-white/[0.07] hover:text-white',
                    )}
                  >
                    {item.icon}
                    {item.label}
        ...
        <div className="border-t border-white/[0.08] p-4">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-[10px] bg-blue-600 text-xs font-bold text-white">{initials}</div>
